...
const (
	...
	BookingService_ListBookingsByPatient_FullMethodName = "/booking.BookingService/ListBookingsByPatient"
	BookingService_ConfirmBooking_FullMethodName        = "/booking.BookingService/ConfirmBooking"
	BookingService_StartBookingSaga_FullMethodName      = "/booking.BookingService/StartBookingSaga"
	BookingService_GetBookingSaga_FullMethodName        = "/booking.BookingService/GetBookingSaga"
)
...
type BookingServiceClient interface {
	...
	ListBookingsByPatient(ctx context.Context, in *ListBookingsByPatientRequest, opts ...grpc.CallOption) (*ListBookingsByPatientResponse, error)
	ConfirmBooking(ctx context.Context, in *ConfirmBookingRequest, opts ...grpc.CallOption) (*ConfirmBookingResponse, error)
	StartBookingSaga(ctx context.Context, in *StartBookingSagaRequest, opts ...grpc.CallOption) (*StartBookingSagaResponse, error)
	GetBookingSaga(ctx context.Context, in *GetBookingSagaRequest, opts ...grpc.CallOption) (*GetBookingSagaResponse, error)
}
...
func (c *bookingServiceClient) ListBookingsByPatient(ctx context.Context, in *ListBookingsByPatientRequest, opts ...grpc.CallOption) (*ListBookingsByPatientResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListBookingsByPatientResponse)
	err := c.cc.Invoke(ctx, BookingService_ListBookingsByPatient_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) StartBookingSaga(ctx context.Context, in *StartBookingSagaRequest, opts ...grpc.CallOption) (*StartBookingSagaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(StartBookingSagaResponse)
	err := c.cc.Invoke(ctx, BookingService_StartBookingSaga_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookingServiceClient) GetBookingSaga(ctx context.Context, in *GetBookingSagaRequest, opts ...grpc.CallOption) (*GetBookingSagaResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBookingSagaResponse)
	err := c.cc.Invoke(ctx, BookingService_GetBookingSaga_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookingServiceServer interface {
	...
	ListBookingsByPatient(context.Context, *ListBookingsByPatientRequest) (*ListBookingsByPatientResponse, error)
	ConfirmBooking(context.Context, *ConfirmBookingRequest) (*ConfirmBookingResponse, error)
	StartBookingSaga(context.Context, *StartBookingSagaRequest) (*StartBookingSagaResponse, error)
	GetBookingSaga(context.Context, *GetBookingSagaRequest) (*GetBookingSagaResponse, error)
...
func (UnimplementedBookingServiceServer) ListBookingsByPatient(context.Context, *ListBookingsByPatientRequest) (*ListBookingsByPatientResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListBookingsByPatient not implemented")
}
...
func (UnimplementedBookingServiceServer) StartBookingSaga(context.Context, *StartBookingSagaRequest) (*StartBookingSagaResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method StartBookingSaga not implemented")
}
func (UnimplementedBookingServiceServer) GetBookingSaga(context.Context, *GetBookingSagaRequest) (*GetBookingSagaResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBookingSaga not implemented")
}
...
func _BookingService_ListBookingsByPatient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListBookingsByPatientRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).ListBookingsByPatient(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_ListBookingsByPatient_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).ListBookingsByPatient(ctx, req.(*ListBookingsByPatientRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _BookingService_StartBookingSaga_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(StartBookingSagaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).StartBookingSaga(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_StartBookingSaga_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).StartBookingSaga(ctx, req.(*StartBookingSagaRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _BookingService_GetBookingSaga_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookingSagaRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookingServiceServer).GetBookingSaga(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookingService_GetBookingSaga_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookingServiceServer).GetBookingSaga(ctx, req.(*GetBookingSagaRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListBookingsByPatient",
			Handler:    _BookingService_ListBookingsByPatient_Handler,
		},
		{
		...
		{
			MethodName: "StartBookingSaga",
			Handler:    _BookingService_StartBookingSaga_Handler,
		},
		{
			MethodName: "GetBookingSaga",
			Handler:    _BookingService_GetBookingSaga_Handler,
		},
	},
