...
- **API Gateway**: Orquestación centralizada y API unificada para reservas y pagos (Go).
- **Booking Service**: Gestión de reservas médicas mediante gRPC y PostgreSQL (Go).
...
│   ├── ...
├── api-gateway/                    # Gateway HTTP unificado (Go)
│   ├── ...
├── booking-service/                # Servicio de reservas (Go)
│   ├── ...
├── frontend/                       # Cliente web de reservas (React)
│   ├── ...
